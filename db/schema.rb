...
ActiveRecord::Schema.define(version: 20180519130319) do
  ...
  create_table "picks", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text "text"
    t.integer "user_id"
    ...
    t.index ["product_id"], name: "index_picks_on_product_id"
  ...
  add_foreign_key "picks", "products"
